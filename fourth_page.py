...
Landscaped_Gardens = Shopping_Mall = School = Hospital = ATM = AC = Wardrobe = TV = Refrigerator = Sofa = Washing_Machine = Wifi = Microwave = ""
Dining_Table = Gas_connection = BED = ""
output = ""
...
class Window(QtGui.QMainWindow):
    ...
    def home(self):
        ...
        self.comboBox33.addItems(['Yes','No'])
        ...
        self.comboBox34.addItems(['Yes','No'])
        ...
        self.comboBox35.addItems(['Yes','No'])
    ...
    def Dining_Table_menu(self):
        global Dining_Table
        Dining_Table = self.comboBox33.currentText()
        
    def Gas_connection_menu(self):
        global Gas_connection
        Gas_connection = self.comboBox34.currentText()
    
    def BED_menu(self):
        global BED
        BED = self.comboBox35.currentText()
    ...
    def next_page(self):	
        ...
        global Golf_Course, Cafeteria, Rain_Water_Harvesting, Staff_Quarter, Multipurpose_Room , Intercom, Landscaped_Gardens, Shopping_Mall, School, Hospital
        global ATM,  AC, Wardrobe, TV, Refrigerator, Sofa, Washing_Machine, Wifi, Microwave, Dining_Table, Gas_connection, BED
