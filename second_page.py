...
area1 = bhk1 = facing1 = carpetarea1 = pricepersquare1 = Vaastu_Compliant1 = neworold1 = locality1 = floor1 = additionalrooms1 = possesiondate1 = status1 = ""
output = ""
...
class Window(QtGui.QMainWindow):
	...
	def facing(self):
	    global facing1
	    facing1 = self.comboBox2.currentText()
	
	def carpetarea_text(self):
	    global carpetarea1
	    carpetarea1 = self.name_line1.text()
	
	def pricepersquare_text(self):
	    global pricepersquare1
	    pricepersquare1 = self.name_line2.text()
	
	def Vaastu_Compliant_menu(self):
	    global Vaastu_Compliant1
	    Vaastu_Compliant1 = self.comboBox3.currentText()
	    
	def new_old(self):
	    global neworold1
	    neworold1 = self.comboBox4.currentText()
	    
	def locality_menu(self):
	    global locality1
	    locality1 = self.comboBox5.currentText()
	
	def floor_text(self):
	    global floor1
	    floor1 = self.name_line3.text()
	    
	def month_menu(self):
	    global possesiondate1
	    possesiondate1 = self.comboBox7.currentText()
	 
	
	def additionalrooms_menu(self):
	    global additionalrooms1
	    additionalrooms1 = self.comboBox6.currentText()
	
	def status_menu(self):
	    global status1
	    status1 = self.comboBox8.currentText()
